...
const API_ENDPOINT = "https://hw9kfk8jff.execute-api.us-east-1.amazonaws.com"; // Replace after terraform apply
const CLOUDFRONT_URL = "https://dwmnmjjtecra.cloudfront.net"; // Replace after terraform apply
...
export default function App() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const uploadJobId = data.jobId;
      
      await axios.put(data.uploadUrl, file, { 
        headers: { 
          'Content-Type': 'video/mp4',
          'x-amz-meta-jobid': uploadJobId
        },
        onUploadProgress: (e) => setProgress(10 + (e.loaded / e.total) * 40)
      });
